...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT(
        ...
        KC_NO, KC_BSLS, KC_PLUS, KC_ASTR, KC_UNDS, KC_LCBR, KC_NO, KC_NO, KC_RCBR, KC_MINS, KC_COMM, KC_DOT, KC_SLSH, KC_NO,
    ...
    [_MODS_NUM_PAD] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_TRNS,  LGUI(KC_SPC), KC_SPACE, KC_P0, KC_PDOT, KC_NO, KC_NO
    ),
    [_APP_CONTROL] = LAYOUT(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
