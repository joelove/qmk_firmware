...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOLS] = LAYOUT_split_3x6_3(
        ...
        KC_NO, KC_BSLS, KC_LT, KC_GT, KC_UNDS, KC_LCBR, KC_RCBR, KC_MINS, KC_COMM, KC_DOT, KC_SLSH, KC_NO,
        LSA(KC_MINS), LALT(KC_MINS), LALT(KC_3), KC_NO, KC_TRNS, KC_NO
    ),
    ...
    [_MODS_NUM_PAD] = LAYOUT_split_3x6_3(
        ...
        KC_NO, KC_TRNS, KC_NO, KC_SPACE, KC_P0, KC_PDOT
    ),
    [_APP_CONTROL] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_NO, LGUI(KC_SPC), KC_NO, KC_NO, KC_NO
    )
};
